 ...
 * =============================================================================
 * 
 * Dropdown select with search/filter functionality.
 * Used for selecting from large lists (document types, processes, users, etc.)
 * 
 * FEATURES:
...
export default function SearchableSelect({
  ...
  // Select an option, close dropdown, clear search
  ...
  const handleClear = (e: React.MouseEvent) => {
    e.stopPropagation();  // Prevent click from toggling the dropdown
    onChange('');
    setSearchTerm('');
  };
   ...
   * (button, search input, option buttons) is excluded.
    ...
    >
      ...
      {isOpen && (
        ...
        >
          ...
          {/* Options List - max-h-60 + overflow-y-auto enable internal scroll */}
